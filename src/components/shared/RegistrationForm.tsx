    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      {!showOtpInput ? (
        <>
          ...
          <div className="space-y-2">
            <Label htmlFor="reg-details">Additional Details (Optional)</Label>
            <Textarea
              id="reg-details"
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
          <div className="space-y-4 p-6 bg-muted/50 rounded-xl border">
            <Label htmlFor="reg-otp" className="flex items-center gap-2 text-lg font-semibold">
              <Mail className="h-5 w-5 text-primary" aria-hidden="true" />
              Verification Code
            </Label>
            <p id="otp-instructions" className="text-sm text-muted-foreground">
            ...
            <div className="flex justify-between items-center pt-2">
              <Button type="button" variant="ghost" size="sm" onClick={() => setShowOtpInput(false)} aria-label="Go back to registration form">
                Back to Form
              </Button>
              <Button type="button" variant="link" size="sm" onClick={sendOtp} disabled={otpSending} aria-label="Resend 6-digit verification code">
                Resend Code
              </Button>
            </div>
          </div>
