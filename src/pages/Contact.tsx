...
const Contact = () => {
  ...
  const contactAddress = settings?.contact_address || "Dept. of BME, CUET, Chittagong-4349, Bangladesh";
  const contactEmail = settings?.contact_email || "bmes@cuet.ac.bd";
  const contactPhone = settings?.contact_phone || "+880 1XXX-XXXXXX";
  const contactMapIframe = settings?.contact_map_iframe || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3688.086300185984!2d91.96884391535497!3d22.46337583990666!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ad2fca34ae5549%3A0x35c88a37b3e90e97!2sChittagong%20University%20of%20Engineering%20and%20Technology%20(CUET)!5e0!3m2!1sen!2sbd!4v1625000000000!5m2!1sen!2sbd";
          ...
          <div>
            ...
            <div className="mt-8 space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div><h4 className="font-semibold text-foreground">Address</h4><p className="text-sm text-muted-foreground">{contactAddress}</p></div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div><h4 className="font-semibold text-foreground">Email</h4><p className="text-sm text-muted-foreground">{contactEmail}</p></div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div><h4 className="font-semibold text-foreground">Phone</h4><p className="text-sm text-muted-foreground">{contactPhone}</p></div>
              </div>
            </div>
            
            <div className="mt-8 rounded-xl overflow-hidden border border-border h-64">
              <iframe 
                src={contactMapIframe} 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
