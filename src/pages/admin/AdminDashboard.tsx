...
const AdminDashboard = () => {
  const [counts, setCounts] = useState({ members: 0, events: 0, projects: 0, achievements: 0, blog: 0, submissions: 0, unread: 0, media: 0, advisors: 0, alumni: 0 });

  useEffect(() => {
    const load = async () => {
      const [m, e, p, a, b, s, u, media, adv, alum] = await Promise.all([
